...
| `ifc-beam-column` | generate `ifc/beam-column.ifc` | `ifc/beam-column.json` | Expect only until IfcOpenShell generates the IFC. |
...
# IFC: IfcOpenShell — IfcBeam + IfcColumn + connection + property set
